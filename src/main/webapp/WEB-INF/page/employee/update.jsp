...
<body>
								...
								<form id="paymentForm" method="post" class="form-horizontal"
									...
									<div class="form-group">
										<div class="group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" name="er" id="er" disabled="disabled"/>
											</div>
										</div>
										<div class="group">
											<label class="col-sm-2 control-label">HR</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" name="hr" id="hr" disabled="disabled"/>
											</div>
										</div>
									</div>
									<br />
									...
									<div class="form-group">
										...
										<div class="col-lg-3">
											<select class="form-control" name="emp_type" data-bv-notempty
												data-bv-notempty-message="Please select role." id="emp_type" data-bv-group=".group">
									...
									<div class="form-group">
										<div style="text-align: center;width:50%;float:left">
											<input type="button" value="Capacity Map Modify" name="subscribe"
	...
	<!-- default loading -->
	<script src="<%=path %>/js/spidernet/updateCapabilityMap.js"></script>
	<script type="text/javascript" src="<%=path %>/js/spidernet/update.js"></script>
